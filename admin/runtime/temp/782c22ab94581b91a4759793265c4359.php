<?php if (!defined('THINK_PATH')) exit(); /*a:8:{s:91:"D:\phpStudy\PHPTutorial\WWW\yifu\admin\public/../application/index\view\users\feedback.html";i:1540461087;s:78:"D:\phpStudy\PHPTutorial\WWW\yifu\admin\application\index\view\public\meta.html";i:1529999324;s:78:"D:\phpStudy\PHPTutorial\WWW\yifu\admin\application\index\view\public\link.html";i:1529999332;s:80:"D:\phpStudy\PHPTutorial\WWW\yifu\admin\application\index\view\public\header.html";i:1540460820;s:78:"D:\phpStudy\PHPTutorial\WWW\yifu\admin\application\index\view\public\left.html";i:1529999338;s:85:"D:\phpStudy\PHPTutorial\WWW\yifu\admin\application\index\view\public\content_top.html";i:1529999370;s:86:"D:\phpStudy\PHPTutorial\WWW\yifu\admin\application\index\view\public\content_foot.html";i:1529999376;s:78:"D:\phpStudy\PHPTutorial\WWW\yifu\admin\application\index\view\public\foot.html";i:1529999360;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<div class="am-g tpl-g">
    ...
    <div class="am-form-inline" role="form">
        ...
        <div class="am-form-group ">
            <input type="text" class="am-form-field am-input-sm" name="end" id="end_time" placeholder="请选择结束日期"
                   data-am-datepicker
        ...
        <a href="<?php echo url('feedback'); ?>?excel=1&name=<?php echo $name; ?>&start_query=<?php echo $start_query; ?>&end_query=<?php echo $end_query; ?>">导出Excel表格</a>
    </div>
            ...
            <form>
                <table class="table table-bordered tablerecord table-hover">
                    ...
                    <tr>
                        ...
                        <td><?php if(($feedback_log['question_type']) == 1): ?>交易<?php elseif(($feedback_log['question_type']) == 2): ?>出入金<?php else: ?>其他<?php endif; ?>
                        </td>
                        <td title="<?php echo $feedback_log['question_describe']; ?>"><?php if((strlen($feedback_log['question_describe']) < 24 )): ?>
                            <?php echo $feedback_log['question_describe']; else: ?>
                            <?php echo substr($feedback_log['question_describe'],0,24); ?>... <?php endif; ?>
                        </td>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" onclick="hiden_detial()" class="close" data-dismiss="modal"
                                aria-hidden="true">
                            &times;
                        </button>
                    ...
                    <div class="modal-footer">
                        <button type="button" style="float: left;" onclick="submit_this_question()" class="btn btnqure"
                                data-dismiss="modal">
                            提交
                        </button>
...
//  	console.log(data);
    ...
    function submit_this_question() {
        //问题id和问题处理意见
        var data = {
            "question_id": $("#question_display_id").html(),
            "question_suggest": $("#question_display_headle_suggestion").val()
        };
        console.log(data);
        $.ajax({
            type: "post",
