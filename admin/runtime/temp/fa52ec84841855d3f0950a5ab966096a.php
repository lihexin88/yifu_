<?php if (!defined('THINK_PATH')) exit(); /*a:8:{s:79:"D:\phpStudy\WWW\yifu\admin\public/../application/index\view\users\user_add.html";i:1540524515;s:66:"D:\phpStudy\WWW\yifu\admin\application\index\view\public\meta.html";i:1529999324;s:66:"D:\phpStudy\WWW\yifu\admin\application\index\view\public\link.html";i:1529999332;s:68:"D:\phpStudy\WWW\yifu\admin\application\index\view\public\header.html";i:1540460820;s:66:"D:\phpStudy\WWW\yifu\admin\application\index\view\public\left.html";i:1529999338;s:73:"D:\phpStudy\WWW\yifu\admin\application\index\view\public\content_top.html";i:1529999370;s:74:"D:\phpStudy\WWW\yifu\admin\application\index\view\public\content_foot.html";i:1529999376;s:66:"D:\phpStudy\WWW\yifu\admin\application\index\view\public\foot.html";i:1529999360;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
    ...
    <form class="am-cf" id="form" onsubmit="return false">
        <div class="widget am-cf">
            ...
            <div class="am-panel am-panel-primary">
                ...
                <div class="am-form-group">
                    ...
                    <label class="am-form-label">
                        <input type="text" id="real_name" class="am-form-field am-input-sm" name="real_name"
                               value="<?php echo isset($list['name'])?$list['name']:' '; ?>"/>
                    </label>
                </div>
                <div class="am-form-group">
                    <span class="s1">手机号：　　</span>
                    <label class="am-form-label">
                        <input type="text" id="phone" class="am-form-field am-input-sm" name="phone" value="<?php echo isset($list['tel'])?$list['tel']:' '; ?>"
                               placeholder=""/>
                    </label>
                </div>
                <div class="am-form-group">
                ...
                <input type="hidden" value="<?php echo isset($list['type'])?$list['type']:''; ?>" name="type">
                <input type="hidden" value="<?php echo isset($list['id'])?$list['id']:''; ?>" name="id">
    ...
    <script type="text/javascript">
        ...
        function sub() {
            ...
            if (arr.p_names == "") {
                ...
                $.ajax({
                    url: "<?php echo url('Users/user_adds'); ?>",
                    data: {arr: arr},
                    type: "post",
                    success: function (r) {
                        // console.log(r);
