...
function(e) {
	...
	this.configDatePicker = function(t) {
		angular.extend(e, t)
	}, this.$get = ["$rootScope", "$ionicPopup", "$ionicModal", "IonicDatepickerService", function(t, n, a, o) {
		function i(e) {
			return e.setHours(0), e.setMinutes(0), e.setSeconds(0), e.setMilliseconds(0), e
		}

		function c(e) {
			e.disabledDates && 0 !== e.disabledDates.length ? (u.disabledDates = [], angular.forEach(e.disabledDates, function(e, t) {
		...
		function d(e) {
			...
			var a, c;
			u.firstDayEpoch = i(new Date(e.getFullYear(), e.getMonth(), t)).getTime(), u.lastDayEpoch = i(new Date(e.getFullYear(), e.getMonth(), n)).getTime();
			for(var d = t; d <= n; d++) a = new Date(e.getFullYear(), e.getMonth(), d), c = a.getTime() < u.fromDate || a.getTime() > u.toDate || u.mainObj.disableWeekdays.indexOf(a.getDay()) >= 0, u.dayList.push({
				date: a.getDate(),
				month: a.getMonth(),
				year: a.getFullYear(),
				day: a.getDay(),
			...
			r = r < 0 ? 6 : r;
			for(var l = 0; l < r; l++) u.dayList.unshift({});
		...
		var s = {},
			u = t.$new();
		u.today = i(new Date).getTime(), u.disabledDates = [], u.data = {}, u.prevMonth = function() {
			1 === u.currentDate.getMonth() && u.currentDate.setFullYear(u.currentDate.getFullYear()), u.currentDate.setMonth(u.currentDate.getMonth() - 1), u.data.currentMonth = u.mainObj.monthsList[u.currentDate.getMonth()], u.data.currentYear = u.currentDate.getFullYear(), d(u.currentDate), _()
		}, u.nextMonth = function() {
			11 === u.currentDate.getMonth() && u.currentDate.setFullYear(u.currentDate.getFullYear()), u.currentDate.setDate(1), u.currentDate.setMonth(u.currentDate.getMonth() + 1), u.data.currentMonth = u.mainObj.monthsList[u.currentDate.getMonth()], u.data.currentYear = u.currentDate.getFullYear(), u.monthChanged(u.currentDate.getMonth()), d(new Date), _()
		};
		var _ = function() {
			var e = new Date(u.selctedDateEpoch);
			e.setMonth(u.currentDate.getMonth()), e.setYear(u.currentDate.getFullYear()), u.selctedDateEpoch = e.getTime(), u.mainObj.callback(u.selctedDateEpoch)
		};
		return u.dateSelected = function(e) {
			e && 0 !== Object.keys(e).length && (u.selctedDateEpoch = e.epoch, u.mainObj.closeOnSelect && (u.mainObj.callback(u.selctedDateEpoch), "popup" == u.mainObj.templateType.toLowerCase() ? u.popup.close() : p()))
		}, u.setIonicDatePickerTodayDate = function() {
			var e = new Date;
			d(new Date), u.selctedDateEpoch = i(e).getTime(), u.mainObj.closeOnSelect && (u.mainObj.callback(u.selctedDateEpoch), p())
		}, u.setIonicDatePickerDate = function() {
			u.mainObj.callback(u.selctedDateEpoch), p()
		}, u.monthChanged = function(e) {
			var t = u.monthsList.indexOf(e);
			u.currentDate.setMonth(t), d(u.currentDate), _()
		}, u.yearChanged = function(e) {
			u.currentDate.setFullYear(e), d(u.currentDate), _()
			...
			var a = [];
			delete u.fromDate, delete u.toDate, u.mainObj = angular.extend({}, e, t), u.mainObj.from && (u.fromDate = i(new Date(u.mainObj.from)).getTime()), u.mainObj.to && (u.toDate = i(new Date(u.mainObj.to)).getTime()), t.disableWeekdays && e.disableWeekdays && (u.mainObj.disableWeekdays = t.disableWeekdays.concat(e.disableWeekdays)), r(u.mainObj), u.mainObj.closeOnSelect || (a = [{
				...
				onTap: function(e) {
					var t = new Date;
					d(new Date), u.selctedDateEpoch = i(t).getTime(), u.mainObj.closeOnSelect || e.preventDefault()
				}
			}), a.push({
	...
	this.monthsList = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"], this.getYearsList = function(e, t) {
		var n = [],
			a = 1900,
			o = 2100;
		a = e ? new Date(e).getFullYear() : a, o = t ? new Date(t).getFullYear() : o;
		for(var i = a; i <= o; i++) n.push(i);
		return n
	}
});