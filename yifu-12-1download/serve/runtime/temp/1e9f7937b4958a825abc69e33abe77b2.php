<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"/www/web/test/yifu/serve/public/../application/index/view/login/login_index.html";i:1540799247;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
	<head>
		...
		$("#btn_login").click(function() {
			...
			if(name == "") {
				...
				$.ajax({
					...
					url:"/index.php/Login/quotation_login",
					success:function(result){
						if(result['code'] == 1){
							layer.msg(result['msg']);
							document.cookie = "token="+result['data']['token'];
							window.location.href = "/index.php/home/index_index";
