<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"/www/web/test/yifu/serve/public/../application/index/view/recharge/index.html";i:1540784539;s:63:"/www/web/test/yifu/serve/application/index/view/base/index.html";i:1540805351;}*/ ?>
<!--首部加载文件-->
...
//			console.log(result);
		...
		function doPay() {
			...
			layer.confirm('请在新页面完成付款', {
				...
				location.href = "/index.php/withdrawal/record.html";
			}, function() {
				layer.msg('请重新付款');
			});
			return true;
		...
		function recharge() {
			$.ajax({
				...
				url: "/index.php/recharge/post_recharge",
				success: function(result) {
//					console.log(result);return false;
					if(result['code'] == 1){
						layer.alert("入金申请已提交",{time:1000});
						window.location.href = "/index.php/recharge/record";						
					}else{
