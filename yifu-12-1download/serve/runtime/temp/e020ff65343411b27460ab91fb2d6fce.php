<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"/www/web/test/yifu/serve/public/../application/index/view/bank/bind.html";i:1540802038;s:63:"/www/web/test/yifu/serve/application/index/view/base/index.html";i:1540805351;}*/ ?>
<!--首部加载文件-->
...
<!--首部--个人中心-->
				...
				<a class="ground-item" href="/index.php/home/index_index" style="text-decoration:none;">个人中心</a>
...
<!--左侧边--安全中心-->
							...
							<li class="submeun-2"><i class="ioc active"></i>
								<a class="l-m-icon active" href="/index.php/security/index.html">安全中心</a><span class="active"></span>
							</li>
						</ul>
...
//							console.log(result);
			...
			function loadEfSupportBanks() {
				App.getJSON("/index.php/bank/efsupportbanks.html", '', function(res) {
//					console.log(res);
					if(res.code) {
						var banks = res.data;
						var options = '';
