<?php if (!defined('THINK_PATH')) exit(); /*a:8:{s:87:"/www/web/test/yifu/admin/public/../application/index/view/transaction/exchange_add.html";i:1540549850;s:64:"/www/web/test/yifu/admin/application/index/view/public/meta.html";i:1529999324;s:64:"/www/web/test/yifu/admin/application/index/view/public/link.html";i:1529999332;s:66:"/www/web/test/yifu/admin/application/index/view/public/header.html";i:1540460820;s:64:"/www/web/test/yifu/admin/application/index/view/public/left.html";i:1529999338;s:71:"/www/web/test/yifu/admin/application/index/view/public/content_top.html";i:1529999370;s:72:"/www/web/test/yifu/admin/application/index/view/public/content_foot.html";i:1529999376;s:64:"/www/web/test/yifu/admin/application/index/view/public/foot.html";i:1529999360;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<div class="am-g tpl-g">
    ...
    <form class="am-cf" id="form" onsubmit="return false">
        <div class="widget am-cf">
            ...
            <div class="am-form-group">
                ...
                <label class="am-form-label">
                    <input type="text" id="name" class="am-form-field am-input-sm" name="name"
                           value="<?php echo !empty($list['name'])?$list['name']:''; ?>"/>
                </label>
            </div>
            <div class="am-form-group">
                ...
                <label class="am-form-label">
                    <input type="text" id="code" class="am-form-field am-input-sm" name="code"
                           value="<?php echo !empty($list['code'])?$list['code']:''; ?>"/>
                </label>
            </div>
            <div class="am-form-group">
                ...
                <label class="am-form-label">
                    <input type="text" id="short" class="am-form-field am-input-sm" name="short"
                           value="<?php echo !empty($list['short'])?$list['short']:''; ?>"/>
                </label>
            </div>
            <div class="am-form-group">
                ...
                <label class="am-form-label">
                    <input type="text" id="sort" class="am-form-field am-input-sm" name="sort" placeholder="数字越小越靠前"
                           value="<?php echo !empty($list['sort'])?$list['sort']:''; ?>"/>
                </label>
            </div>
            <div class="am-form-group">
            ...
            <input type="hidden" name="id" value="<?php echo !empty($list['id'])?$list['id']:'0'; ?>">
            <div class="am-panel-bd" style="padding-bottom: 1rem;margin-left: 13rem">
                ...
                <a href="exchange.html?a=<?php echo $a; ?>&b=<?php echo $b; ?>" class="am-btn am-btn-secondary am-btn-sm">返回</a>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    function sub() {
        ...
        $.ajax({
            url: "<?php echo url('Transaction/exchange_adds'); ?>",
            data: {arr: arr},
            type: "post",
            success: function (r) {
                if (r['code'] == 1) {
