<?php if (!defined('THINK_PATH')) exit(); /*a:8:{s:83:"/www/web/test/yifu/admin/public/../application/index/view/transaction/var_edit.html";i:1540461552;s:64:"/www/web/test/yifu/admin/application/index/view/public/meta.html";i:1529999324;s:64:"/www/web/test/yifu/admin/application/index/view/public/link.html";i:1529999332;s:66:"/www/web/test/yifu/admin/application/index/view/public/header.html";i:1540460820;s:64:"/www/web/test/yifu/admin/application/index/view/public/left.html";i:1529999338;s:71:"/www/web/test/yifu/admin/application/index/view/public/content_top.html";i:1529999370;s:72:"/www/web/test/yifu/admin/application/index/view/public/content_foot.html";i:1529999376;s:64:"/www/web/test/yifu/admin/application/index/view/public/foot.html";i:1529999360;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
        ...
        <div class="am-panel am-panel-primary">
                ...
                <div class="am-form-group">
                    ...
                    <label class="am-form-label">
                        ...
                        <?php if(is_array($exchange) || $exchange instanceof \think\Collection || $exchange instanceof \think\Paginator): $i = 0; $__LIST__ = $exchange;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if($vo['id'] == $list['bourse']): ?>
                ...
                <div class="am-form-group">
                    ...
                    <label class="am-form-label">
                        <input type="text" id="name" class="am-form-field am-input-sm" name="name" value="<?php echo $list['name']; ?>" />
                    </label>
                </div>
                ...
                <div class="am-form-group">
                    <span class="s1">短　码：　　</span>
                    <label class="am-form-label">
                        <input type="text" id="short" class="am-form-field am-input-sm" name="short" value="<?php echo $list['short']; ?>" />
                    </label>
                </div>

                <div class="am-form-group">
                    <span class="s1">类  型：　　</span>
                    <label class="am-form-label">
                        <input type="text" id="industry" class="am-form-field am-input-sm" name="industry" value="<?php echo $list['industry']; ?>" />
                    </label>
                </div>               
