<?php if (!defined('THINK_PATH')) exit(); /*a:8:{s:83:"/www/web/test/yifu/admin/public/../application/index/view/transaction/exchange.html";i:1540540792;s:64:"/www/web/test/yifu/admin/application/index/view/public/meta.html";i:1529999324;s:64:"/www/web/test/yifu/admin/application/index/view/public/link.html";i:1529999332;s:66:"/www/web/test/yifu/admin/application/index/view/public/header.html";i:1540460820;s:64:"/www/web/test/yifu/admin/application/index/view/public/left.html";i:1529999338;s:71:"/www/web/test/yifu/admin/application/index/view/public/content_top.html";i:1529999370;s:72:"/www/web/test/yifu/admin/application/index/view/public/content_foot.html";i:1529999376;s:64:"/www/web/test/yifu/admin/application/index/view/public/foot.html";i:1529999360;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<div class="am-g tpl-g">
    ...
    <ol class="am-breadcrumb">
        ...
        <li><a href="../transaction/exchange_add.html?a=<?php echo $a; ?>&b=<?php echo $b; ?>">添加交易所</a></li>
    </ol>
            ...
            <div class="am-scrollable-horizontal">
                <table class="<?php echo $table; ?>">
                    ...
                    <tr>
                        ...
                        <?php if(strtoupper($vo['status']) == '0'): ?>
                        <td><a href="#" onclick="mod_status(<?php echo $vo['id']; ?>,<?php echo $vo['status']; ?>)"
                               class="am-btn am-btn-warning am-btn-xs"><?php echo $vo['status_text']; ?></a></td>
                        <?php else: ?>
                        <td><a href="#" onclick="mod_status(<?php echo $vo['id']; ?>,<?php echo $vo['status']; ?>)"
                               class="am-btn am-btn-success am-btn-xs"><?php echo $vo['status_text']; ?></a></td>
                        <?php endif; ?>
                        <td><?php echo $vo['sort']; ?></td>
                        <td><?php echo $vo['time']; ?></td>
                        <td>
                            <a href="exchange_add?id=<?php echo $vo['id']; ?>&a=<?php echo $a; ?>&b=<?php echo $b; ?>"
...
<form action="<?php echo $url; ?>" class="am-form-inline" role="form" id="form" method="get">
    ...
    <script type="text/javascript">
        ...
        function mod_status(id, status) {
            ...
            $.ajax({
                url: "<?php echo url('Transaction/mod_status'); ?>",
                type: "post",
