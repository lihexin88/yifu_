<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:73:"/www/web/test/yifu/admin/public/../application/index/view/home/index.html";i:1540553564;s:64:"/www/web/test/yifu/admin/application/index/view/public/meta.html";i:1529999324;s:64:"/www/web/test/yifu/admin/application/index/view/public/link.html";i:1529999332;s:66:"/www/web/test/yifu/admin/application/index/view/public/header.html";i:1540460820;s:64:"/www/web/test/yifu/admin/application/index/view/public/left.html";i:1529999338;s:64:"/www/web/test/yifu/admin/application/index/view/public/foot.html";i:1529999360;}*/ ?>
﻿<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
            ...
            <div class="row am-cf">
                <div class="am-u-sm-12 am-u-md-6 am-u-lg-3">
                    <div class="widget widget-purple am-cf"
                        ...
                        <div class="widget-statistic-header">总会员人数:</div>
                        <div class="widget-statistic-body">
                            <div class="widget-statistic-value"><?php echo $list['sum_people']; ?></div>
                ...
                <div class="am-u-sm-12 am-u-md-6 am-u-lg-3">
                    <div class="widget widget-purple am-cf"
                         style=" background: #57c8f2;border: 1px solid #57c8f2;border-top: 2px solid #57c8f2;">
                        <div class="widget-statistic-header">禁用人数:</div>
                        <div class="widget-statistic-body">
                            <div class="widget-statistic-value"><?php echo $list['disable_people']; ?></div>
                            <span class="widget-statistic-icon am-icon-credit-card-alt"
                                  style="color: #5fbfe2"></span>
                        </div>
                    </div>
                ...
                <div class="row am-cf">
                    <div class="am-u-sm-12 am-u-md-6 am-u-lg-3">
                        <div class="widget widget-purple am-cf"
                             style=" background: #57c8f2;border: 1px solid #57c8f2;border-top: 2px solid #57c8f2;">
                            <div class="widget-statistic-header">总交易量</div>
                            <div class="widget-statistic-body">
                    ...
                    <div class="am-u-sm-12 am-u-md-6 am-u-lg-3">
                        <div class="widget widget-purple am-cf"
                             style=" background: #57c8f2;border: 1px solid #57c8f2;border-top: 2px solid #57c8f2;">
                            <div class="widget-statistic-header">今日成交量</div>
                            <div class="widget-statistic-body">
                                <div class="widget-statistic-value">¥<?php echo $list['sum_day_deal']; ?></div>
                                <span class="widget-statistic-icon am-icon-credit-card-alt"
                                      style="color: #5fbfe2"></span>
                            </div>
                        </div>
