<?php if (!defined('THINK_PATH')) exit(); /*a:9:{s:91:"D:\phpStudy\PHPTutorial\WWW\yifu\admin\public/../application/index\view\users\rechange.html";i:1535337314;s:78:"D:\phpStudy\PHPTutorial\WWW\yifu\admin\application\index\view\public\meta.html";i:1529999324;s:78:"D:\phpStudy\PHPTutorial\WWW\yifu\admin\application\index\view\public\link.html";i:1529999332;s:78:"D:\phpStudy\PHPTutorial\WWW\yifu\admin\application\index\view\public\form.html";i:1529999356;s:80:"D:\phpStudy\PHPTutorial\WWW\yifu\admin\application\index\view\public\header.html";i:1529999348;s:78:"D:\phpStudy\PHPTutorial\WWW\yifu\admin\application\index\view\public\left.html";i:1529999338;s:85:"D:\phpStudy\PHPTutorial\WWW\yifu\admin\application\index\view\public\content_top.html";i:1529999370;s:80:"D:\phpStudy\PHPTutorial\WWW\yifu\admin\application\index\view\public\editor.html";i:1521772962;s:78:"D:\phpStudy\PHPTutorial\WWW\yifu\admin\application\index\view\public\foot.html";i:1529999360;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
        ...
        <form class="am-cf" id="form" onsubmit="return false">
            <div class="am-panel am-panel-primary">
                ...
                <div class="am-form-group">
                    <span class="s1">充值会员</span>
                    <label class="am-form-label">
                        <input type="text" id="" class="am-form-field am-input-sm" name="" value="<?php echo $list['name']; ?>" disabled="" />
                    </label>
                </div>
                <input type="hidden" id="tireal_nametle" class="am-form-field am-input-sm" name="id" value="<?php echo $id; ?>" />
                <div class="am-form-group">
                        <span class="s1">充值来源：</span>
                        <label class="am-form-label">
                            <select name="pay_type" title="" class="am-form-field am-input-sm">
                                <option value="1" selected>网银支付</option>
                                <option value="2">认证支付</option>
                            </select>
                        </label>
                </div>
                <div class="am-form-group">
                    <span class="s1">充值金额：</span>
                    <label class="am-form-label">
                        <input type="text" id="number" class="am-form-field am-input-sm" name="number" value="" placeholder="最多两位小数" />
                        
                    </label>
                </div>
                <div class="am-form-group">
                    <span class="s1">充值手续费：</span>
                    <label class="am-form-label">
                        <input type="text" id="fee" class="am-form-field am-input-sm" name="fee" value="" placeholder="最多两位小数"/>
                        
                    </label>
                </div>
                 <div class="am-form-group">
                    <span class="s1">到账金额：</span>
                    <label class="am-form-label">
                        <input type="text" id="account" class="am-form-field am-input-sm" name="account" value="" placeholder="最多两位小数" />
                ...
                <div class="am-form-group">
                    ...
                    <label class="am-form-label">
                        <input type="text" id="remark" class="am-form-field am-input-sm" name="remark" value=""  />
...
<script type="text/javascript">
    ...
    function sub() {
        ...
        $.ajax({
            url: "<?php echo url('Users/rechange_info'); ?>",
            data: {arr: arr},
            type: "post",
            success: function (r) {
                // console.log(r);
