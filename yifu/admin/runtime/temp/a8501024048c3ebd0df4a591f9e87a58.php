<?php if (!defined('THINK_PATH')) exit(); /*a:8:{s:97:"D:\phpStudy\PHPTutorial\WWW\yifu\admin\public/../application/index\view\transaction\var_edit.html";i:1535105520;s:78:"D:\phpStudy\PHPTutorial\WWW\yifu\admin\application\index\view\public\meta.html";i:1529999324;s:78:"D:\phpStudy\PHPTutorial\WWW\yifu\admin\application\index\view\public\link.html";i:1529999332;s:80:"D:\phpStudy\PHPTutorial\WWW\yifu\admin\application\index\view\public\header.html";i:1529999348;s:78:"D:\phpStudy\PHPTutorial\WWW\yifu\admin\application\index\view\public\left.html";i:1529999338;s:85:"D:\phpStudy\PHPTutorial\WWW\yifu\admin\application\index\view\public\content_top.html";i:1529999370;s:86:"D:\phpStudy\PHPTutorial\WWW\yifu\admin\application\index\view\public\content_foot.html";i:1529999376;s:78:"D:\phpStudy\PHPTutorial\WWW\yifu\admin\application\index\view\public\foot.html";i:1529999360;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
        ...
        <div class="am-panel am-panel-primary">
                ...
                <div class="am-form-group">
                    ...
                    <label class="am-form-label">
                        <select name="exchange_id" title="" class="am-form-field am-input-sm">
                        <?php if(is_array($exchange) || $exchange instanceof \think\Collection || $exchange instanceof \think\Paginator): $i = 0; $__LIST__ = $exchange;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if($vo['id'] == $list['exchange_id']): ?>
                ...
                <div class="am-form-group">
                    ...
                    <label class="am-form-label">
                        <input type="text" id="variety_name" class="am-form-field am-input-sm" name="variety_name" value="<?php echo $list['variety_name']; ?>" />
                    </label>
                </div>

                <div class="am-form-group">
                    <span class="s1">代　码：　　</span>
                    <label class="am-form-label">
                        <input type="text" id="code" class="am-form-field am-input-sm" name="code" value="<?php echo $list['code']; ?>" />
                    </label>
                </div>

                <div class="am-form-group">
                    <span class="s1">最小变动单位:</span>
                    <label class="am-form-label">
                        <input type="text" id="min_unit" class="am-form-field am-input-sm" name="min_unit" value="<?php echo $list['min_unit']; ?>"  placeholder=""/>
                        
                    </label>
                </div>
            
                <div class="am-form-group">
                    <span class="s1">合约乘数：　</span>
                    <label class="am-form-label">
                        <input type="text" id="contract_multipler" class="am-form-field am-input-sm" name="contract_multipler" value="<?php echo $list['contract_multipler']; ?>" />
                    </label>
                </div>
                ...
                <div class="am-form-group">
                    ...
                    <label class="am-form-label">
                        <input type="text" id="open_position_fee" class="am-form-field am-input-sm" name="open_position_fee" value="<?php echo $list['open_position_fee']; ?>"  placeholder=""/>
                    </label>
                </div>
                ...
                <div class="am-form-group">
                    ...
                    <label class="am-form-label">
                        <input type="text" id="close_position_fee" class="am-form-field am-input-sm" name="close_position_fee" value="<?php echo $list['close_position_fee']; ?>" />
                    </label>
                </div>
...
//        nav.eq(1).find('a').addClass("active");
    ...
    function sub() {
        ...
        if(arr.p_names == ""){
            ...
            $.ajax({
                url: "<?php echo url('Transaction/update_edit'); ?>",
                data: {arr: arr},
                type: "post",
                success: function (r) {
                    // console.log(r);
