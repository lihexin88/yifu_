<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:91:"D:\phpStudy\WWW\yifu\Interface\public/../application/index\view\security\loginpassword.html";i:1539672153;s:69:"D:\phpStudy\WWW\yifu\Interface\application\index\view\base\index.html";i:1539671571;}*/ ?>
<!--首部加载文件-->
		...
		<div class="container-fluid header-1">
			<div class="container h1-content">
				...
				<div class="col-md-7 text-right" style="float:right;">
					<a href="" >欢迎您，<?php echo $user_info['name']; ?><input type="text" value="<?php echo $user_info['id']; ?>" style="display: none;" id="user_id" /></a>
...
<!--左侧边--安全中心-->
							...
							<li class="submeun-2"><i class="ioc active"></i>
								<a class="l-m-icon active" href="/security/index.html">安全中心</a>
