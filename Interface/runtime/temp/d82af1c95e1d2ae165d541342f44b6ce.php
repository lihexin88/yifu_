<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"D:\phpStudy\WWW\yifu\Interface\public/../application/index\view\recharge\record.html";i:1539687324;s:69:"D:\phpStudy\WWW\yifu\Interface\application\index\view\base\index.html";i:1539943090;}*/ ?>
<!--首部加载文件-->
...
<li class="submeun-5"><i class="ioc active" style="top: 12px"></i>
	<a class="l-m-icon active" href="/recharge/record.html">入金记录</a>
...
<div class="crumbs">
	<div class="container"> 管理系统&nbsp;&gt;&nbsp;个人中心&nbsp;&gt;&nbsp;入金记录 </div>
</div>

<!--右侧显示内容-->

<h1 class="page_title">入金记录</h1>
<div class="full" id="dg1">
	<table class="table table-bordered tablerecord table-hover" width="100%" align="center">
		...
		<tbody id="table">
			<?php if(is_array($record) || $record instanceof \think\Collection || $record instanceof \think\Paginator): $i = 0; $__LIST__ = $record;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$record): $mod = ($i % 2 );++$i;?>
			<tr>
				<td><?php echo date("Y-m-d H:i:s",$record['time']); ?></td>
				<td><?php echo $record['order']; ?></td>
				<td><?php echo $record['number']; ?></td>
				<td><?php echo $record['usd']; ?></td>
				<td><?php if(($record['status'] == 0)): ?>未支付<?php elseif(($record['status'] == 1)): ?>已支付<?php elseif(($record['status'] == 2)): ?>已拒绝<?php endif; ?></td>
			</tr>
			<?php endforeach; endif; else: echo "" ;endif; ?>
		</tbody>
	</table>
	<?php echo $record_page; ?> 
<!--右侧显示内容结束-->
