<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"D:\phpStudy\WWW\yifu\Interface\public/../application/index\view\security\index.html";i:1539685255;s:69:"D:\phpStudy\WWW\yifu\Interface\application\index\view\base\index.html";i:1539943090;}*/ ?>
<!--首部加载文件-->
			...
			<li> <span class="mingzi">绑定银行卡&nbsp;&nbsp;</span>
				...
				<div class="set_rightb"> <span style="">银行卡已绑定</span>
					<div class="setright"><span class="textsuccess">已绑定</span>
						<span style="color:gray;">&nbsp;|&nbsp;</span>
						<a href="/bank/bind.html" name="flag">修改</a>
					</div>
				</div>
				<?php else: ?>
				<div class="set_rightb"> <span style="">未绑定银行卡，暂时无法进行出入金操作，请先绑定银行卡</span>
					<div class="setright"><span style="color: red;">未绑定</span>
						<span style="color:gray;">&nbsp;|&nbsp;</span>
						<a href="/bank/bind.html" name="flag">绑定</a>
					</div>
				</div>
				<?php endif; ?>
			</li>
